...
var Controls = styled.div(_templateObject3());
var ButtonMac = styled.button(_templateObject4());
var ButtonMacMaximize = styled(ButtonMac)(_templateObject5(), function (props) {
  return props.showMaximize ? '0' : '1';
}, function (props) {
  return props.showMaximize ? 'none' : 'block';
}, function (props) {
  return props.showMaximize ? '1' : '0';
}, function (props) {
  return props.showMaximize ? 'block' : 'none';
});
var ButtonMacClose = styled(ButtonMac)(_templateObject6());
var ButtonMacMinimize = styled(ButtonMac)(_templateObject7());
var ButtonWindows = styled.button(_templateObject8());
var CloseButtonWindows = styled(ButtonWindows)(_templateObject9());
...
function (_PureComponent) {
  _inherits(Titlebar, _PureComponent);
  ...
  function Titlebar() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "isWindows", window.clientInformation.platform === 'Win32');
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleMinimize", function () {
      currentWindow.minimize();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleMaximize", function () {
      if (_this.isWindows) {
        ...
        var keyAltDown = _this.state.keyAltDown;
  ...
  _createClass(Titlebar, [{
    ...
    value: function renderMac() {
      ...
      return React__default.createElement(Controls, {
        key: "title-controls"
      }, React__default.createElement(ButtonMacClose, {
        tabIndex: "-1",
      ...
      }))), React__default.createElement(ButtonMacMinimize, {
        tabIndex: "-1",
        ...
        width: "8",
        height: "1.1"
      }))), React__default.createElement(ButtonMacMaximize, {
    ...
    value: function renderWindows() {
      ...
      return React__default.createElement(Controls, {
        key: "title-controls"
      }, React__default.createElement(ButtonWindows, {
        "aria-label": "minimize",
        tabIndex: "-1",
        onClick: this.handleMinimize
      }, React__default.createElement("svg", {
        ...
        tabIndex: "-1",
        onClick: this.handleMaximize
      }, isMaximized ? React__default.createElement("svg", {
        version: "1.1",
        "aria-hidden": "true",
        width: "10",
        height: "10"
      ...
      }))), React__default.createElement(CloseButtonWindows, {
        "aria-label": "close",
        tabIndex: "-1",
        onClick: this.handleClose
      }, React__default.createElement("svg", {
    ...
    value: function render() {
      ...
      if (this.isWindows) {
        elements.push(React__default.createElement(Text, {
          key: "title-text",
